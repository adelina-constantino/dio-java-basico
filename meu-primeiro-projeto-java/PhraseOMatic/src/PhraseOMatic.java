public class PhraseOMatic {
    public static void main(String[] args) throws Exception {
        ...
        String[] wordListTwo = {"habilitado", "adesivo", "valor agregado", "orientado", "central","distribuído", "agrupado", "solidificado", "independente de máquina", "posicionado", "destinado", "compartilhado", "cooperativo", "acelerado"};
